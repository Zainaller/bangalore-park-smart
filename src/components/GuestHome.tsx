      ...
      <div className="flex flex-col items-center space-y-12 py-8 px-4 pb-16">
        <div className="w-full max-w-6xl mx-auto relative">
          <Carousel className="w-full" setApi={setCarouselApi}>
            <CarouselContent>
              {cityImages.map((image, index) => <CarouselItem key={index}>
                  <div className="relative h-[60vh] w-full overflow-hidden rounded-xl">
                    <img src={image.src} alt={image.title} className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" />
                    <div className="absolute inset-0 bg-gradient-to-t from-background via-background/50 to-transparent">
                      <div className="absolute bottom-0 left-0 p-8 text-white">
                        ...
                        tab: 'signup'
                          ...
                          <Button size="lg" variant="outline" onClick={() => navigateTo('auth', {
                        tab: 'login'
        ...
        <div className="text-center space-y-6 max-w-2xl mx-auto relative">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" onClick={() => navigateTo('search')} className="group">
              <span className="group-hover:scale-110 transition-transform duration-300 inline-flex items-center">
        ...
        <div className="w-full max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-lg overflow-hidden h-80 relative group">
              <img src="https://images.unsplash.com/photo-1576721843264-5375e54e2f49?q=80&w=2000" alt="Modern parking structure" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
            ...
            <div className="rounded-lg overflow-hidden h-80 relative group">
              <img src="https://images.unsplash.com/photo-1611806616581-65903ea68ac0?q=80&w=2000" alt="Tech city parking" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-background via-background/50 to-transparent flex flex-col justify-end p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-blue-900/20 to-primary/10 rounded-xl p-6 relative overflow-hidden group">
              ...
              <div className="h-48 mb-4 overflow-hidden rounded-lg relative">
                <img src="https://images.unsplash.com/photo-1551544931-49dbf9a76618?q=80&w=2000" alt="3D Parking Map" className="w-full h-full object-cover group-hover:scale-110 transition-all duration-700" />
            ...
            <div className="bg-gradient-to-br from-purple-900/20 to-primary/10 rounded-xl p-6 relative overflow-hidden group">
              ...
              <div className="h-48 mb-4 overflow-hidden rounded-lg relative">
                <img src="https://images.unsplash.com/photo-1511300961358-669ca3ad05af?q=80&w=2000" alt="AR Parking Guide" className="w-full h-full object-cover group-hover:scale-110 transition-all duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-background/90 to-transparent"></div>
                <div className="absolute bottom-3 left-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5">
              <div className="lg:col-span-2 p-8 flex flex-col justify-center">
                ...
                <ul className="space-y-3 mb-6">
                  {["Predict parking availability with 94% accuracy", "Save up to 40 minutes on your daily commute", "Reduce carbon emissions by minimizing idle driving", "Access historical data to plan future trips"].map((item, i) => <li key={i} className="flex items-start">
                ...
                <Button onClick={() => navigateTo('auth')} className="bg-gradient-to-r from-primary to-primary/80 hover:opacity-90 transition-opacity w-full md:w-auto">
